...
const CAREGIVER_TEXT = {
  zh: {
    ...
    features: [
      ...
      { id: "sos", title: "SOS 求救", desc: "看護可代受顧者發出緊急求救，送出位置與聯絡電話。", historyPath: "/caregiver/sos/history", createPath: "/caregiver/sos/trigger", createType: "sos" },
  ...
  en: {
    ...
    features: [
      ...
      { id: "sos", title: "Emergency SOS", desc: "Caregivers can trigger urgent help for the patient with location and contact phone.", historyPath: "/caregiver/sos/history", createPath: "/caregiver/sos/trigger", createType: "sos" },
  ...
  id: {
    ...
    features: [
      ...
      { id: "sos", title: "SOS Darurat", desc: "Perawat dapat mengirim bantuan darurat untuk pasien dengan lokasi dan nomor kontak.", historyPath: "/caregiver/sos/history", createPath: "/caregiver/sos/trigger", createType: "sos" },
  ...
  vi: {
    ...
    features: [
      ...
      { id: "sos", title: "SOS Khẩn Cấp", desc: "Y tá có thể gửi yêu cầu khẩn cấp cho bệnh nhân kèm vị trí và số liên hệ.", historyPath: "/caregiver/sos/history", createPath: "/caregiver/sos/trigger", createType: "sos" },
  ...
  tl: {
    ...
    features: [
      ...
      { id: "sos", title: "Emergency SOS", desc: "Maaaring magpadala ang tagapag-alaga ng agarang tulong para sa pasyente kasama ang lokasyon at telepono.", historyPath: "/caregiver/sos/history", createPath: "/caregiver/sos/trigger", createType: "sos" },
  ...
  th: {
    ...
    features: [
      ...
      { id: "sos", title: "SOS ฉุกเฉิน", desc: "ผู้ดูแลสามารถส่งคำขอฉุกเฉินแทนผู้ป่วย พร้อมตำแหน่งและเบอร์ติดต่อ", historyPath: "/caregiver/sos/history", createPath: "/caregiver/sos/trigger", createType: "sos" },
