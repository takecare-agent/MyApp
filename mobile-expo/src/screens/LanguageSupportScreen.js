...
const UI_TEXT = {
  ...
  en: {
    ...
    voiceUnavailable: "This phone has no speech engine. Please type instead.",
    back: "Back",
  ...
  id: {
    ...
    voiceUnavailable: "HP ini tidak punya mesin suara. Ketik saja.",
    back: "Kembali",
  ...
  vi: {
    ...
    voiceUnavailable: "Máy này không có nhận dạng giọng. Hãy gõ chữ.",
    back: "Quay Lại",
  ...
  tl: {
    ...
    voiceUnavailable: "Walang speech engine ang phone na ito. Mag-type na lang.",
    back: "Bumalik",
  ...
  th: {
    ...
    voiceUnavailable: "มือถือเครื่องนี้ไม่มีระบบเสียง พิมพ์แทน",
    back: "กลับ",
