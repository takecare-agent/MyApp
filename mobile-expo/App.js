...
import FamilyCareRecordsScreen from "./src/screens/FamilyCareRecordsScreen"
...
export default function App() {
  ...
  const handleOpenFeature = feature => {
    ...
    } else if (feature?.id === "reminders") {
      setActiveScreen("reminder-list")
    } else if (feature?.id === "care-logs") {
      setActiveScreen("care-log")
    } else if (feature?.id === "care-records" && session?.role === "family") {
      setActiveScreen("family-care-records")
    } else {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {activeScreen === "family-care-records" ? (
          <FamilyCareRecordsScreen
            apiBaseUrl={session.apiBaseUrl}
            token={session.token}
            role={session.role}
            onBack={() => setActiveScreen("home")}
